# --- Research-only partial-state pruning for colored-port generation ---

"""
Statistics for the research-only pruned colored-port traversal.
...
This is an internal research entry point for measuring downstream pruning strategies. `keep_child`
must define an automorphism-invariant, extension-monotone property. The generic GraphCombinations
backend does not assign any physical meaning to the predicate.
"""
